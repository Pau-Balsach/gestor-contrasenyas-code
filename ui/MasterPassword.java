...
public class MasterPassword extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            String master = new String(masterChars).trim();

            if (esPrimeraVez) {
                String confirmar = new String(confirmarChars).trim();
                if (!master.equals(confirmar)) {
            ...
            String error = AuthService.configurarMasterKey(master);
            if (error != null) {
            ...
            // Limpiar ambos arrays de memoria pase lo que pase
